...
class Civilization():
    ...
    def build_world(self):
        """ Builds a 2D worlds that consists of random cells that are either "W" (water) or "L" (land) """
    ...
    def find_random_location(self):
        ...
        # Generate a random number between 0 and dimension - 1
        y = random.randrange(0, self.dimension -1)
        print("Let's find out if you are on a continent or in the ocean. You are at {}, {}".format(y,y))
        self.find_continent((y-1, y-1))
        return True
