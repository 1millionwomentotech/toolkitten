import unittest
from alice_in_wonderland_dict import alice_letter_counter_dict

class TestAliceDictionary(unittest.TestCase):
	...
	def test0(self):
		...
		self.assertEqual(alice_letter_counter_dict(), expected) 
