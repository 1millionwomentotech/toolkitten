filename = input("What's the name of the file you want to open?")
...
#********** This is an alternate version from the study drill. Using input only and not argv to open the file.
